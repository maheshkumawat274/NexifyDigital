...
const DigitalTopsection: React.FC = () => {
  return (
    <div className="relative w-full h-[70vh] md:h-[70vh] flex items-center justify-center text-center text-white">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/imgs/about.jpg')`, // Replace with your actual image path
        }}
      >
      ...
      <div className="relative z-10 max-w-3xl p-6 space-y-6">
        ...
        <h2 className="text-xl sm:text-3xl font-semibold text-blue-300">
          Boost visibility, generate leads & grow your brand online
        </h2>

        <p className="text-sm sm:text-xl text-gray-200">
          We offer SEO, social media marketing, Google Ads, and content strategies to attract, engage, and convert your target audience into loyal customers.
        </p>
...
export default DigitalTopsection;
